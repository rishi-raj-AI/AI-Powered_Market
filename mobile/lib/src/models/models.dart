...
class StoreProduct {
  final String id; final String productId; final String name; final String unit; final String price; final String? mrp; final int stock; final bool isAvailable;
  ...
  factory StoreProduct.fromJson(Map<String,dynamic> j)=>StoreProduct(id:j['id'],productId:j['product_id'],name:j['product']['name'],unit:j['product']['unit'],price:j['price'].toString(),mrp:j['mrp']?.toString(),stock:j['stock_quantity']??0,isAvailable:j['is_available']??false);
}

class CartItemModel {
  final String id; final int quantity; final StoreProduct product;
...
class CartModel {
  final String id; final String? storeId; final List<CartItemModel> items; final String subtotal;
...
class OrderModel {
  final String id; final String orderNumber; final String status; final String paymentMethod; final String paymentStatus; final String total; final String createdAt;
...
class DeliveryModel {
  final String id; final String orderId; final String status;
...
class DeliveryTaskModel {
  final String id; final String orderId; final String orderNumber; final String status; final String paymentMethod; final String paymentStatus; final String total; final String storeName; final String? storePhone; final String? storeLandmark; final double? storeLatitude; final double? storeLongitude; final String? recipientName; final String? recipientPhone; final String? houseDetails; final String customerLandmark; final String? customerDirections; final double? customerLatitude; final double? customerLongitude;
  DeliveryTaskModel({required this.id,required this.orderId,required this.orderNumber,required this.status,required this.paymentMethod,required this.paymentStatus,required this.total,required this.storeName,this.storePhone,this.storeLandmark,this.storeLatitude,this.storeLongitude,this.recipientName,this.recipientPhone,this.houseDetails,required this.customerLandmark,this.customerDirections,this.customerLatitude,this.customerLongitude});
  factory DeliveryTaskModel.fromJson(Map<String,dynamic> j)=>DeliveryTaskModel(id:j['id'],orderId:j['order_id'],orderNumber:j['order_number'],status:j['status'],paymentMethod:j['payment_method'],paymentStatus:j['payment_status'],total:j['total'].toString(),storeName:j['store_name'],storePhone:j['store_phone'],storeLandmark:j['store_landmark'],storeLatitude:(j['store_latitude'] as num?)?.toDouble(),storeLongitude:(j['store_longitude'] as num?)?.toDouble(),recipientName:j['recipient_name'],recipientPhone:j['recipient_phone'],houseDetails:j['house_details'],customerLandmark:j['customer_landmark'],customerDirections:j['customer_directions'],customerLatitude:(j['customer_latitude'] as num?)?.toDouble(),customerLongitude:(j['customer_longitude'] as num?)?.toDouble());
}

class PaymentConfigModel {
  final bool enabled; final String provider; final String? keyId;
...
class PaymentIntentModel {
  final String paymentAttemptId; final String providerOrderId; final int amountSubunits; final String currency; final String keyId;
  ...
  factory PaymentIntentModel.fromJson(Map<String,dynamic> j)=>PaymentIntentModel(paymentAttemptId:j['payment_attempt_id'],providerOrderId:j['provider_order_id'],amountSubunits:j['amount_subunits'],currency:j['currency'],keyId:j['key_id']);
}

class NotificationEventModel {
  final String id; final String eventType; final String title; final String body; final String status; final String createdAt;
  ...
  factory NotificationEventModel.fromJson(Map<String,dynamic> j)=>NotificationEventModel(id:j['id'],eventType:j['event_type'],title:j['title'],body:j['body'],status:j['status'],createdAt:j['created_at']);
}
