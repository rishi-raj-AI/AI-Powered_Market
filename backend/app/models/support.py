...
class SupportMessage(Base):
    ...
    __table_args__ = (
        CheckConstraint("visibility IN ('public', 'internal')", name="ck_support_messages_visibility"),
        UniqueConstraint("ticket_id", "idempotency_key", name="uq_support_messages_ticket_idempotency"),
    )
