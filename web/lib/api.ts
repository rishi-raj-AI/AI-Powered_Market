...
export type Store={id:string;merchant_id:string;village_id:string;service_area_id?:string;name:string;slug:string;description?:string;phone?:string;landmark?:string;latitude?:number;longitude?:number;delivery_enabled:boolean;pickup_enabled:boolean;is_active:boolean};
export type NearbyStore=Store&{distance_km:number};
export type StoreCreate={village_id:string;service_area_id?:string|null;name:string;slug:string;description?:string;phone?:string;landmark?:string;latitude?:number;longitude?:number;delivery_enabled:boolean;pickup_enabled:boolean};
...
export type DeliveryTask={id:string;order_id:string;order_number:string;status:string;payment_method:string;payment_status:string;total:string;store_name:string;store_phone?:string;store_landmark?:string;store_latitude?:number;store_longitude?:number;recipient_name?:string;recipient_phone?:string;house_details?:string;customer_landmark:string;customer_directions?:string;customer_latitude?:number;customer_longitude?:number};
export type NotificationEvent={id:string;user_id:string;event_type:string;title:string;body:string;data:Record<string,unknown>;status:string;created_at:string;sent_at?:string};
export type PaymentConfig={enabled:boolean;provider:string;key_id?:string;currency:string};
export type AdminOverview={users:number;active_stores:number;merchants:{pending:number;approved:number};orders:{total:number;by_status:Record<string,number>};paid_gmv:string};
