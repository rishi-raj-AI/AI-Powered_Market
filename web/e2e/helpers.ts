...
const overview={users:6,villages:1,active_stores:1,merchants:{pending:1,approved:1,suspended:0},orders:{total:1,by_status:{ready:1}},operations:{low_stock_listings:0,ready_unassigned_deliveries:1,active_delivery_partners:1},paid_gmv:'0',gross_order_value:'240'};
